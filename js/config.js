(function (global) {
  ...
  Config.IGNORED_INVOICE_TYPES = [
    ...
    // البحرين
    'فاتورة مبيعات البُديّع',
    'فاتورة مبيعات التنين 1',
    'فاتورة مبيعات التنين 3',
    'فاتورة مبيعات الجهراء',
    'فاتورة مبيعات الرفاع',
    'فاتورة مبيعات انستغرام البحرين',
    'فاتورة مبيعات جد علي',
    'فاتورة مبيعات ذا جيت مول',
    'فاتورة مبيعات رملي مول',
    // عمان
    'مرتجع مبيعات انستغرام',
    ...
    // البحرين
    'مرتجع مبيعات البُديّع',
    'مرتجع مبيعات التنين 1',
    'مرتجع مبيعات التنين 3',
    'مرتجع مبيعات الجهراء',
    'مرتجع مبيعات الرفاع',
    'مرتجع مبيعات انستغرام',
    'مرتجع مبيعات جد علي',
    'مرتجع مبيعات ذا جيت مول',
    'مرتجع مبيعات رملي مول',
  ];
